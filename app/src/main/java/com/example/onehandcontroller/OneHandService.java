...
public class OneHandService extends AccessibilityService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        floatingLayout.findViewById(R.id.btn).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initFloatingPadLayoutParams() {
        int layoutFlag;
    ...
    private void setSwipeViewListener() {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        if(curMode == CLICK_MODE) {
                            ...
                            cursorX = Math.max(cursorX, -displayWidth / 2 - cursorWidth / 2);
                            cursorY = Math.max(cursorY, -displayHeight / 2 - cursorHeight / 2);
                            cursorX = Math.min(cursorX, displayWidth / 2 - cursorWidth / 2);
                            cursorY = Math.min(cursorY, displayHeight / 2 - cursorHeight / 2);
                            cursorParams.x = cursorX;
                            cursorParams.y = cursorY;
